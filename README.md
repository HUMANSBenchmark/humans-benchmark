...
An efficient benchmark for evaluating Large Audio Models using minimal evaluation subsets while predicting human preferences through learned regression weights.
...
evaluator = HUMANSEvaluator(
    dataset_name="HUMANSBenchmark/humans-benchmark",
    subset="n50"
)
...
```bash
pip install git+https://github.com/HUMANSBenchmark/humans-benchmark.git
```

### Option 2: Clone and install in editable mode

```bash
git clone https://github.com/HUMANSBenchmark/humans-benchmark.git
cd humans-benchmark
pip install -e .
```
...
```python
evaluator = HUMANSEvaluator(
    dataset_name: str = "HUMANSBenchmark/humans-benchmark",
    subset: str = "n50",
...
- `dataset_name` (str): HuggingFace dataset identifier
  - Default: `"HUMANSBenchmark/humans-benchmark"`
...
- **Dataset:** [HuggingFace Dataset](https://huggingface.co/datasets/HUMANSBenchmark/humans-benchmark)
- **Repository:** [GitHub](https://github.com/HUMANSBenchmark/humans-benchmark)
- **Issues:** [Bug Tracker](https://github.com/HUMANSBenchmark/humans-benchmark/issues)
